...
const Overview = () => {
    ...
    return(
        <Container id="overview">
            ...
            <Text my="auto" mb={10} pt={10} color="primary" fontSize="3xl" fontWeight="bold">Frontend skills</Text>
            ...
            <Text my={10} color="primary" fontSize="3xl" fontWeight="bold">Backend skills</Text>
